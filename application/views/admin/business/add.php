      ...
      <div class="card card-default">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <div class="col-md-12">
              <input type="text" name="business_name" class="form-control" id="name" placeholder="">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-12">
              <textarea rows="5" col="5" name="long_description" class="form-control editors"></textarea>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-12">
            <input type="text" name="price" class="form-control" id="name" placeholder="">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-12">
            <input type="text" name="mobile_number" class="form-control" id="name" placeholder="">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-12">
            <input type="text" name="website" class="form-control" id="name" placeholder="">
            </div>
          </div>
          ...
          <div class="form-group">
            <input type="checkbox" name="is_propular" id="is_propular" value="1"> Mark as Featured
          </div>
